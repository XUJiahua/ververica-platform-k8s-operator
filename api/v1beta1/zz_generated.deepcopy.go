...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VpV1PodTemplateSpec) DeepCopyInto(out *VpV1PodTemplateSpec) {
	*out = *in
	if in.Metadata != nil {
		in, out := &in.Metadata, &out.Metadata
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VpV1PodTemplateSpec.
func (in *VpV1PodTemplateSpec) DeepCopy() *VpV1PodTemplateSpec {
	if in == nil {
		return nil
	}
	out := new(VpV1PodTemplateSpec)
