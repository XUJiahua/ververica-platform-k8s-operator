 ...
 * @param optional nil or *DeleteSavepointUsingDELETEOpts - Optional Parameters:
     * @param "Force" (optional.Bool) -  force


*/

type DeleteSavepointUsingDELETEOpts struct {
	Force optional.Bool
}

func (a *SavepointResourceApiService) DeleteSavepointUsingDELETE(ctx context.Context, namespace string, savepointId string, localVarOptionals *DeleteSavepointUsingDELETEOpts) (*http.Response, error) {
	var (
